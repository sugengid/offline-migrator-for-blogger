...
class BMIG_Parser {
	...
	public function parse( $file_path ) {
		if ( ! is_readable( $file_path ) ) {
			...
			return new WP_Error( 'bmig_feed_unreadable', sprintf( __( 'Feed file could not be read: %s', 'sugeng-offline-migrator-for-blogger' ), $file_path ) );
		}
		...
		if ( false === $xml ) {
			return new WP_Error( 'bmig_feed_invalid', __( 'Feed file is not valid XML.', 'sugeng-offline-migrator-for-blogger' ) );
		}
