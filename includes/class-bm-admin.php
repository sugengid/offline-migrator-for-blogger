		...
		wp_localize_script(
			...
			array(
				...
				'strings'    => array(
					...
					'sessionLost'      => __( 'The upload was no longer active on the server. Select the file and upload again.', 'sugeng-offline-migrator-for-blogger' ),
					'finishRetry'      => __( 'Finishing the upload failed. Select the same file and press Upload again to continue without re-uploading it.', 'sugeng-offline-migrator-for-blogger' ),
